    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="{{route('country.store')}}" class="form" id="add_form" method="POST">
               @csrf   
                <div class="modal-body" id="modalbody">
                       
                  <div class="form-group">
                    <label>Country Name</label>
                      <input type="text" class="form-control" id="edit_country_name" name="country_name" placeholder="Country Name" autocomplete="off" value="{{ old('country_name') }}" require >
                      <span class="text-red">
                                <strong class="country_name"></strong>
                      </span>
                  </div>
...
<script type="text/javascript">
  var dataTableRoute = "{{ route('country.fetch') }}";
  var editRoute = "{{route('country.edit')}}";
  var activeRoute = "{{route('country.active')}}";
  var disableRoute = "{{route('country.disable')}}";
